// Last updated: 4/3/2026, 7:59:12 AM
struct Robot{
	int index;
	int position;
	int health;
...
public:
	vector<int> survivedRobotsHealths(vector<int>& positions,vector<int>& healths,string directions){
		...
		ranges::sort(robots,ranges::less{},[](const Robot& robot){return robot.position;});
		...
		ranges::sort(stack,ranges::less{},[](const Robot& robot){return robot.index;});
